  ...
  stages {
    ...
    stage('Build webserver image') {
      ...
      steps {
        ...
        sh "ssh ubuntu@${ipadr.buildserver_ip.value} sudo docker build -t webserver /webserver/"
        ...
        sh "ssh ubuntu@${ipadr.buildserver_ip.value} sudo docker image tag webserver ${env.DOCKERHUB_CREDS_USR}/webserver"
        sh "ssh ubuntu@${ipadr.buildserver_ip.value} sudo docker images"
        sh "ssh ubuntu@${ipadr.buildserver_ip.value} sudo docker push ${env.DOCKERHUB_CREDS_USR}/webserver"
