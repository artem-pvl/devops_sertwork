  ...
  stages {
    ...
    stage('Run webserver') {
      steps {
        ...
        sh "ssh ubuntu@${ipadr.webserver_ip.value} sudo DOCKERHUB_CREDS_USR=${env.DOCKERHUB_CREDS_USR}"
        sh "ssh ubuntu@${ipadr.webserver_ip.value} sudo echo $DOCKERHUB_CREDS_USR"
